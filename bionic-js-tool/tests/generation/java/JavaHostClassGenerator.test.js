...
describe('JavaHostClassGenerator', () => {
    ...
    test('class parts order', () => {
        ...
        t.expectCode(code,
            ...
            '    }',
            '    ',
            '    public static Long staticProperty1() {',
            '        return bjs.getLong(bjs.getProperty(bjsClass, "staticProperty1"));',
            '    }',
            '    public static void staticProperty1(Long value) {',
            '        bjs.setProperty(bjsClass, "staticProperty1", bjs.putPrimitive(value));',
            '    }',
            '    ',
            '    public static Long staticProperty2() {',
            '        return bjs.getLong(bjs.getProperty(bjsClass, "staticProperty2"));',
            '    }',
            '    public static void staticProperty2(Long value) {',
            '        bjs.setProperty(bjsClass, "staticProperty2", bjs.putPrimitive(value));',
            '    }',
            '    ',
            '    public static Long staticMethod1() {',
            '        return bjs.getLong(bjs.call(bjsClass, "staticMethod1"));',
            '    }',
            '    ',
            '    public static Long staticMethod2() {',
            '        return bjs.getLong(bjs.call(bjsClass, "staticMethod2"));',
            '    }',
            '    ',
            ...
            '    }',
            '    ',
            '    public Long instanceProperty1() {',
            '        return bjs.getLong(bjsGetProperty("instanceProperty1"));',
            '    }',
            '    public void instanceProperty1(Long value) {',
            '        bjsSetProperty("instanceProperty1", bjs.putPrimitive(value));',
            '    }',
            '    ',
            '    public Long instanceProperty2() {',
            '        return bjs.getLong(bjsGetProperty("instanceProperty2"));',
            '    }',
            '    public void instanceProperty2(Long value) {',
            '        bjsSetProperty("instanceProperty2", bjs.putPrimitive(value));',
            '    }',
            '    ',
            '    public Long instanceMethod1() {',
            '        return bjs.getLong(bjsCall("instanceMethod1"));',
            '    }',
            '    ',
            '    public Long instanceMethod2() {',
            '        return bjs.getLong(bjsCall("instanceMethod2"));',
            '    }',
            '    ',
            ...expectedFactoryMethod,
            '}')
