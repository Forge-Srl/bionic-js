...
describe('JavaWrapperClassGenerator', () => {
    ...
    test('class parts order', () => {
        ...
        t.expectCode(code,
            ...getExpectedHeader(),
            '    Long instanceProperty1();',
            '    void instanceProperty1(Long value);',
            '    Long instanceProperty2();',
            '    void instanceProperty2(Long value);',
            '    Long instanceMethod1();',
            '    Long instanceMethod2();',
            '    ',
            ...getExpectedWrapperHeader(),
            '        @BjsNativeWrapperTypeInfo.Exporter',
            '        public static BjsNativeExports bjsExportFunctions(BjsNativeExports nativeExports) {',
            ...
            '            return jsReferences -> {',
            '                Long result_bjs0 = invokeStatic("staticProperty1", new Class[]{}, new Object[]{});',
            ...
            '            return jsReferences -> {',
            '                invokeStatic("staticProperty1", new Class[]{Long.class}, new Object[]{bjs.getLong(jsReferences[0])});',
            '                return bjs.jsUndefined();',
            '            };',
            '        }',
            '        ',
            ...
            '            return jsReferences -> {',
            '                Long result_bjs0 = invokeStatic("staticProperty2", new Class[]{}, new Object[]{});',
            '                return bjs.putPrimitive(result_bjs0);',
            '            };',
            '        }',
            '        ',
            ...
            '            return jsReferences -> {',
            '                invokeStatic("staticProperty2", new Class[]{Long.class}, new Object[]{bjs.getLong(jsReferences[0])});',
            '                return bjs.jsUndefined();',
            '            };',
            '        }',
            '        ',
            ...
            '            return jsReferences -> {',
            '                Long result_bjs0 = invokeStatic("staticMethod1", new Class[]{}, new Object[]{});',
            '                return bjs.putPrimitive(result_bjs0);',
            '            };',
            '        }',
            '        ',
            ...
            '            return jsReferences -> {',
            '                Long result_bjs0 = invokeStatic("staticMethod2", new Class[]{}, new Object[]{});',
            '                return bjs.putPrimitive(result_bjs0);',
            '            };',
            '        }',
            '        ',
            ...
            '            return jsReferences -> {',
            '                ((Class1BjsExport) bjs.getWrapped(jsReferences[0])).instanceProperty1(bjs.getLong(jsReferences[1]));',
            '                return bjs.jsUndefined();',
            '            };',
            '        }',
            '        ',
            ...
            '            return jsReferences -> {',
            '                ((Class1BjsExport) bjs.getWrapped(jsReferences[0])).instanceProperty2(bjs.getLong(jsReferences[1]));',
            '                return bjs.jsUndefined();',
            '            };',
            '        }',
            '        ',
    ...
    test('class parts order, withScaffold', () => {
        ...
        t.expectCode(code,
            ...
            '            return jsReferences -> {',
            '                ((Class1BjsExport) bjs.getWrapped(jsReferences[0])).property(bjs.getLong(jsReferences[1]));',
            '                return bjs.jsUndefined();',
            '            };',
            '        }',
            '        ',
            ...
            '        ',
            '    }',
            '    public void property(Long value) {',
            '        ',
            '    }',
            '    ',
            '    public Long method() {',
