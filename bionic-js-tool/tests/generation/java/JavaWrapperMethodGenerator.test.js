...
describe('JavaWrapperMethodGenerator', () => {
    ...
    test('primitive return, primitive param', () => {
        ...
        t.expectCode(code,
            ...expectedHeader,
            '    Long method1(Boolean boolParam);',
            '    ',
            ...getFunctionsExportCode(['.exportFunction("bjs_method1", singleton.bjs_method1())']),
            '        ',
            '        protected FunctionCallback<?> bjs_method1() {',
    ...
    test('primitive return, primitive param, static', () => {
        ...
        t.expectCode(code,
            ...
            '        protected FunctionCallback<?> bjsStatic_method1() {',
            '            return jsReferences -> {',
            '                Long result_bjs0 = invokeStatic("method1", new Class[]{Boolean.class}, new Object[]{bjs.getBoolean(jsReferences[0])});',
    ...
    test('multiple primitive params', () => {
        ...
        t.expectCode(code,
            ...expectedHeader,
            '    void method1(Boolean boolParam, Long intParam);',
            '    ',
            ...getFunctionsExportCode(['.exportFunction("bjs_method1", singleton.bjs_method1())']),
            '        ',
            '        protected FunctionCallback<?> bjs_method1() {',
            '            return jsReferences -> {',
            '                ((Class1BjsExport) bjs.getWrapped(jsReferences[0])).method1(bjs.getBoolean(jsReferences[1]), bjs.getLong(jsReferences[2]));',
            '                return bjs.jsUndefined();',
            '            };',
            '        }',
            ...expectedFooter)
    ...
    test('void lambda return, void lambda param', () => {
        ...
        t.expectCode(code,
            ...
            '                Lambda.F0<Void> nativeFunc_bjs1 = ((Class1BjsExport) bjs.getWrapped(jsReferences[0])).method1(bjs.getFunc(jsFunc_bjs0, (Lambda.F0<Void>) () -> {',
