...
describe('JavaWrapperPropertyGenerator', () => {
    ...
    test('IntType, only getter, static', () => {
        ...
        t.expectCode(code,
            ...
            '            return jsReferences -> {',
            '                Long result_bjs0 = invokeStatic("property1", new Class[]{}, new Object[]{});',
    ...
    test('IntType, only setter, static', () => {
        ...
        t.expectCode(code,
            ...
            '            return jsReferences -> {',
            '                invokeStatic("property1", new Class[]{Long.class}, new Object[]{bjs.getLong(jsReferences[0])});',
            '                return bjs.jsUndefined();',
            '            };',
            '        }',
            ...expectedFooter)
    ...
    test('LambdaType', () => {
        ...
        t.expectCode(code,
            ...
            '                ((Class1BjsExport) bjs.getWrapped(jsReferences[0])).property1(bjs.getFunc(jsFunc_bjs0, (Lambda.F1<Lambda.F0<Void>, Lambda.F0<Void>>) (jsFunc_bjs0_v0) -> {',
