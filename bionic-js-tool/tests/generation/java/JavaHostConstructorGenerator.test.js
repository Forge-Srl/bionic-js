...
describe('JavaHostConstructorGenerator', () => {
    ...
    test('single primitive', () => {
        ...
        t.expectCode(code,
            ...
            '    }',
            '    ',
            '    public Class1(Long intParam) {',
            '        this(bjs_Class1(intParam));',
            '    }',
            '    ',
            '    private static JSReference[] bjs_Class1(Long intParam) {',
    ...
    test('multiple primitives', () => {
        ...
        t.expectCode(code,
            ...
            '    }',
            '    ',
            '    public Class1(Boolean boolParam, Long intParam) {',
            '        this(bjs_Class1(boolParam, intParam));',
            '    }',
            '    ',
            '    private static JSReference[] bjs_Class1(Boolean boolParam, Long intParam) {',
    ...
    test('void lambda, lambda returning primitive, primitive', () => {
        ...
        t.expectCode(code,
            ...
            '    }',
            '    ',
            '    public Class1(Lambda.F0<Void> voidNativeFunc, Lambda.F0<Long> intNativeFunc, Lambda.F0<Long[]> arrayNativeFunc, Long intPar) {',
            '        this(bjs_Class1(voidNativeFunc, intNativeFunc, arrayNativeFunc, intPar));',
            '    }',
            '    ',
            '    private static JSReference[] bjs_Class1(Lambda.F0<Void> voidNativeFunc, Lambda.F0<Long> intNativeFunc, Lambda.F0<Long[]> arrayNativeFunc, Long intPar) {',
            '        Lambda.F0<Void> nativeFunc_bjs0 = voidNativeFunc;',
            '        FunctionCallback<?> jsFunc_bjs1 = jsReferences_bjs2 -> {',
            '            jsReferences_bjs2 = bjs.ensureArraySize(jsReferences_bjs2, 0);',
            '            nativeFunc_bjs0.apply();',
            '            return bjs.jsUndefined();',
            '        };',
            '        Lambda.F0<Long> nativeFunc_bjs3 = intNativeFunc;',
            ...
            '        };',
            '        Lambda.F0<Long[]> nativeFunc_bjs6 = arrayNativeFunc;',
    ...
    test('lambda taking lambda taking void lambda', () => {
        ...
        t.expectCode(code,
            ...
            '            nativeFunc_bjs0.apply(bjs.getFunc(jsFunc_bjs3, (Lambda.F1<Lambda.F0<Void>, Void>) (jsFunc_bjs3_v0) -> {',
    ...
    test('array of lambdas taking and returning array of void lambdas', () => {
        ...
        t.expectCode(code,
            ...
            '                    return bjs.getFunc(jsFunc_bjs5, (Lambda.F0<Void>) () -> {',
