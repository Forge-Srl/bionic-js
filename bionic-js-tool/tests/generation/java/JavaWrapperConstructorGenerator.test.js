...
describe('JavaWrapperConstructorGenerator', () => {
    ...
    const publicConstructorWithIntParamBindCode = [
        ...
        '                Class1BjsExport bound = bjs.getBound(jsReferences[1], realImplementation);',
        '                if (bound == null) {',
        '                    bound = invokeConstructor(new Class[]{Long.class}, new Object[]{bjs.getLong(jsReferences[1])});',
        '                }',
        '                bjs.bindNative(bound, jsReferences[0]);',
        '                return bjs.jsUndefined();',
        '            };',
    ...
    test('multiple primitives', () => {
        ...
        t.expectCode(code,
            ...
            '                Class1BjsExport bound = bjs.getBound(jsReferences[1], realImplementation);',
            '                if (bound == null) {',
            '                    bound = invokeConstructor(new Class[]{Boolean.class, Long.class}, new Object[]{bjs.getBoolean(jsReferences[1]), bjs.getLong(jsReferences[2])});',
            '                }',
            '                bjs.bindNative(bound, jsReferences[0]);',
            '                return bjs.jsUndefined();',
            '            };',
    ...
    test('void lambda, lambda returning primitive, primitive', () => {
        ...
        t.expectCode(code,
            ...
            '                    bound = invokeConstructor(new Class[]{Lambda.F0.class, Lambda.F0.class, Lambda.F0.class, Long.class}, new Object[]{bjs.getFunc(jsFunc_bjs0, (Lambda.F0<Void>) () -> {',
            '                        bjs.funcCall(jsFunc_bjs0);',
            '                        return null;',
            '                    }), bjs.getFunc(jsFunc_bjs1, (Lambda.F0<Long>) () -> {',
            '                        return bjs.getLong(bjs.funcCall(jsFunc_bjs1));',
            '                    }), bjs.getFunc(jsFunc_bjs2, (Lambda.F0<Long[]>) () -> {',
            '                        return bjs.getArray(bjs.funcCall(jsFunc_bjs2), r_bjs3 -> {',
            '                            return bjs.getLong(r_bjs3);',
            '                        }, Long.class);',
            '                    }), bjs.getLong(jsReferences[4])});',
            '                }',
            '                bjs.bindNative(bound, jsReferences[0]);',
            '                return bjs.jsUndefined();',
            '            };',
