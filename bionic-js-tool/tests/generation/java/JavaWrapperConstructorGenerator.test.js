...
describe('JavaWrapperConstructorGenerator', () => {
    ...
    test('void lambda', () => {
        ...
        t.expectCode(code,
            ...
            '                    bound = invokeConstructor(new Class[]{Lambda.F0.class}, new Object[]{bjs.getFunc(jsFunc_bjs0, () -> {',
    ...
    test('void lambda, lambda returning primitive, primitive', () => {
        ...
        t.expectCode(code,
            ...
            '                    bound = invokeConstructor(new Class[]{Lambda.F0.class, Lambda.F0.class, Lambda.F0.class, Integer.class}, new Object[]{bjs.getFunc(jsFunc_bjs0, () -> {',
            '                        bjs.funcCall(jsFunc_bjs0);',
            '                        return null;',
